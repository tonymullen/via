...
import { AbstractGamePiecesLoader } from './abstract-game-pieces-loader';
 ...
 */
@Directive({
  selector: 'game-pieces-loader',
  providers: [{ provide: AbstractObject3D, useExisting: forwardRef(() => GamePiecesLoaderDirective) }]
})
export class GamePiecesLoaderDirective extends AbstractGamePiecesLoader {
